...
public class MainPageTest {
    ...
    public void url() {
        ...
        issuance.get(0).click();

//       Не разобрался как сделать это через вспомогательный метод, делал все как в уроке, клик не происходит если пользуюсь вспомогательным методом
//       Помогите плиз
